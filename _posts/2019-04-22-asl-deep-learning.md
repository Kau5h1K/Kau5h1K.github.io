...
```
    ...
    Epoch 1/2
    1600/1600 [==============================] - 4s 2ms/step - loss: 0.8923 - acc: 0.7169
    Epoch 2/2
    1600/1600 [==============================] - 3s 2ms/step - loss: 0.4534 - acc: 0.9369
...
```
    ...
    <ipython-input-35-a940a223a600> in <module>()
         10 # Print mislabeled examples
         11 fig = plt.figure(figsize=(25,4))
    ---> 12 for i, idx in enumerate(bad_test_idxs):
         13     ax = fig.add_subplot(2, np.ceil(len(bad_test_idxs)/2), i + 1, xticks=[], yticks=[])
