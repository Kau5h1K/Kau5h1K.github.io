...
---
## Further Reading
-  For more information about bees, see the [BeeSpotter project](https://beespotter.org/) or the [DrivenData competition](https://www.drivendata.org/competitions/8/). Be sure to checkout Part-II of this project [Naïve Bees: Predict Species from images]().
